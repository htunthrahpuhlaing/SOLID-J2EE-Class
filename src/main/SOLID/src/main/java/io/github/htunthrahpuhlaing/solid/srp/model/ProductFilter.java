...
//			if(out.getColor()==color) System.out.println(out.getName());
//		}
//	}
//	
//	public void filter(List<Product> products, Size size) {
//		for(Product out: products) {
//			if(out.getSize()==size) System.out.println(out.getName());
//		}
//	}
//
//	public void filter(List<Product> products,Color color, Size size) {
//		for(Product out: products) {
//			if(out.getColor()==color && out.getSize()==size) System.out.println(out.getName());
//		}
//	}
